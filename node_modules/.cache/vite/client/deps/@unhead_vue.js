...
import {
  createHooks
} from "./chunk-MKCJN47U.js";
import "./chunk-F3FYYIAV.js";

// ../node_modules/.pnpm/@unhead+shared@1.9.4/node_modules/@unhead/shared/dist/index.mjs
...
// ../node_modules/.pnpm/@unhead+dom@1.9.4/node_modules/@unhead/dom/dist/index.mjs
...
// ../node_modules/.pnpm/unhead@1.9.4/node_modules/unhead/dist/index.mjs
...
function useScript(_input, _options) {
  ...
  const instance = new Proxy({}, {
    get(_, fn) {
      ...
      const stub = (_a2 = options.stub) == null ? void 0 : _a2.call(options, { script: $script, fn });
      if (stub)
        return stub;
      if (fn === "$script")
        return $script;
      return (...args) => {
        ...
        if (head.ssr || !options.use)
          return;
        return script.status === "loaded" ? (_b = (_a3 = options.use())[fn]) == null ? void 0 : _b.call(_a3, ...args) : loadPromise.then((api) => {
          var _a4;
          return (_a4 = api[fn]) == null ? void 0 : _a4.call(api, ...args);
        });
      };
    }
  });
...
// ../node_modules/.pnpm/@unhead+vue@1.9.4_vue@3.4.21/node_modules/@unhead/vue/dist/shared/vue.cf295fb1.mjs
...
// ../node_modules/.pnpm/@unhead+vue@1.9.4_vue@3.4.21/node_modules/@unhead/vue/dist/shared/vue.f36acd1f.mjs
...
// ../node_modules/.pnpm/@unhead+vue@1.9.4_vue@3.4.21/node_modules/@unhead/vue/dist/index.mjs
var VueHeadMixin = {
  created() {
    let source = false;
    if (Vue3) {
...
function useScript2(_input, _options) {
  ...
  return instance = useScript(input, options);
}
export {
  CapoPlugin,
  HashHydrationPlugin,
