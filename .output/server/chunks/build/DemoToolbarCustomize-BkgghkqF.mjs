import { i as useState, _ as __nuxt_component_2 } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "DemoToolbarCustomize",
  __ssrInlineRender: true,
  setup(__props) {
    useState("switcher-open", () => false);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/global/DemoToolbarCustomize.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=DemoToolbarCustomize-BkgghkqF.mjs.map
